...
def fibrous_system(num_meshes, radius, height, lower_bound, upper_bound, tolerance):
    ...
    for i in range(num_meshes):
        ...
        temp_center = [random.uniform(lower_bound, upper_bound), random.uniform(lower_bound, upper_bound), 0]
